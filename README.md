...
真实飞书端到端 API 闭环已补齐；下一步是把 bootstrap -> pipeline write -> human decision -> analytics 串成可重复 runbook 并做真实 smoke。详细计划见 [Live MVP Work Plan](docs/live-mvp-work-plan.md)。
